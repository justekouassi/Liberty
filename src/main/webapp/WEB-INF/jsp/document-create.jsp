			...
			<div class="d-flex flex-column" id="content-wrapper">
				...
				<div id="content">
					...
					<div class="container-fluid">
						...
						<form class="form" method="POST" enctype="multipart/form-data" action="/documents/create">
							...
							<div class="input-container half ic2">
								<input class="input" id="sujet" name="sujet" type="text" placeholder=" " />
								<div class="cut"></div>
							...
							<div class="input-container half ic2">
								<input class="input" id="file" name="file" type="file" placeholder=" " />
								<div class="cut"></div>
