			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-2">
						...
						<a class="d-none d-sm-inline btn btn-sm btn-primary shadow-sm" href="ajout.html">Ajouter</a>
					</div>
								...
								<table class="table-bordered table" id="dataTable" width="100%" cellspacing="0">
									...
									<tbody>
										...
										<tr>
											...
											<td><%= "date " + j %></td>
											<td>
												<a class="btn btn-success btn-sm suppression" href="/documents/$document->id/delete">
													<i class="fa fa-download"></i>
												</a>
												<a class="btn btn-primary btn-sm" href="/documents/$document->id/edit">
													<i class="fa fa-pen"></i>
												</a>
												<a class="btn btn-danger btn-sm suppression" href="/documents/$document->id/delete">
